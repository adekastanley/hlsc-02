...
// 						Our Expertise
// 					</h2>
// 					<p className="font-montserrat text-lg leading-relaxed text-gray-300">
// 						We provide incisive solutions backed by our strong understanding of
// 						the local environment. Our cross-cutting experience enables us to
// 						deliver holistic improvements in the health and development sector.
// 					</p>
// 				</div>

// 				<div className="relative mx-auto max-w-4xl">
// 					{/* Vertical Line */}
// 					<div className="absolute left-8 top-0 h-full w-0.5 bg-chemonics-lime md:left-1/2 md:-ml-[1px]">
// 						<motion.div
// 							style={{
...
// 								description:
// 									"Data-driven insights to inform policy and practice.",
// 							},
// 							{
// 								year: "03",
...
// 								description:
// 									"Capacity building and workforce development for the sector.",
// 							},
// 						].map((item, index) => (
// 							<motion.div
// 								key={index}
...
// 							>
// 								{/* Center Icon */}
// 								<div className="absolute left-0 z-10 flex h-10 w-10 shrink-0 items-center justify-center rounded-none-none bg-chemonics-lime text-xl font-bold text-chemonics-navy shadow-lg shadow-chemonics-lime/50 md:left-1/2 md:-translate-x-1/2">
