...
const focusAreas = [
	{
		...
		description:
			"Building resilient health infrastructure and governance structures to ensure sustainable healthcare delivery across communities.",
		icon: "🏥",
	},
	{
		title: "Policy Analysis & Development",
		description:
			"Formulating and reviewing data-driven health policies to improve outcomes and ensuring effective implementation frameworks.",
		icon: "📜",
	},
	{
		title: "Health Financing",
		description:
			"Developing sustainable financing models and economic reviews to ensure equitable access to quality healthcare services.",
		icon: "💰",
	},
	{
		title: "Human Resources for Health",
		description:
			"Strengthening the health workforce through training, capacity building, and effective management strategies.",
		icon: "👥",
	},
	{
		title: "MERL",
		description:
			"Monitoring, Evaluation, Research, and Learning to drive evidence-based decision making and program improvement.",
		icon: "📊",
	},
];
